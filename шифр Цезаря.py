...
while shift == 0 or shift < 0:
    try:  # что бы проверить является ли введенная строка числом попробуем преобразовать ее в int и будем ловить исключение
        ...
        if shift < 0:  # проверка, что введенный шаг сдвига положительное число
            print('\033[31m', 'Введенный шаг сдвига должен быть задан положительным числом !!!' + Style.RESET_ALL)
